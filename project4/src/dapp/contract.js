...
export default class Contract {
    ...
    initialize(callback) {
        ...
        this.web3.eth.getAccounts((error, accts) => {
            ...
            if (accts[0] != self.firstAirlineAddress) {
                throw new Error(` ${accts[0]}, dApp can not be initialized. The account[1] must match the already registered firstAirlineAddress`);
            }
